...
describe('Cart', () => {
  ...
  describe('getTotal()', () => {
    ...
    it('should update total when a product gets included and than removed', () => {
      cart.add({
        product,
        quantity: 2,
      });
  ...
  describe('special conditions', () => {
    ...
    it('should receive two or more conditions and teremine/apply the best discount. First case', () => {
      const condition1 = {
        percentage: 30,
        minimum: 2,
      };
    ...
    it('should receive two or more conditions and teremine/apply the best discount. Second case', () => {
      const condition1 = {
        percentage: 80,
        minimum: 2,
      };
